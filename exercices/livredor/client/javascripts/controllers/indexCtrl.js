...
function escapeSpecialChars(texte){
  return texte
    .replace(/</g, "&gt;")
    .replace(/>/g, "&lt;")
    .replace(/\"/g, "&quot;")
...
$("#ajouter").click(function(){
  var auteur = escapeSpecialChars(document.getElementById("textAuteur").value);
  var message = escapeSpecialChars(document.getElementById("txtMessage").value);
  ajouterMessage(auteur, message, addMessagesSuccess, addMessagesError);
})
